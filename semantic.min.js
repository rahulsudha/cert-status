...
$(document).ready(function() {
    ...
    $("#cb1").change(function() {
        if ($(this).prop("checked")) {
            ...
            $("#secondtab").removeAttr("data-tab");
            $("#secondtabdata").removeClass("active");
            $("#secondtabdata").removeAttr("data-tab");


        } else {
            $("#secondtab").removeClass("disabled");
            $("#secondtab").attr("data-tab", "second");
            $("#secondtabdata").attr("data-tab", "second");
    ...
    $("#cb2").change(function() {
        if ($(this).prop("checked")) {
            // to MNR VPN
            $("#endpoints").attr("disabled", "disabled");
            $("#quotasize").attr("disabled", "disabled");
            $("#todisable").addClass("disabled");
            $("#todisable2").addClass("disabled");
            $("#ingress").addClass("disabled");
            $("#egress").addClass("disabled");

            $("#ingressbox").removeClass("teal");
            $("#egressbox").removeClass("teal");
            $("#maxendpoints").removeClass("tealcolor");
            $("#vpnquota").removeClass("tealcolor");
            $("#typein").attr("disabled", "disabled");
            $("#typein2").attr("disabled", "disabled");

            document.getElementById('endpoints').value = "Inactive";
            document.getElementById('quotasize').value = "Inactive";

            document.getElementById("typein").checked = false;
            document.getElementById("typein2").checked = false;
            $("#typeinb").addClass("hideme");
            $("#typeinb2").addClass("hideme");

        } else {
            // To Guaranteed VPN
            $("#endpoints").removeAttr("disabled", "disabled");
            $("#quotasize").removeAttr("disabled", "disabled");
            $("#todisable").removeClass("disabled");
            $("#todisable2").removeClass("disabled");
            $("#ingress").removeClass("disabled");
            $("#egress").removeClass("disabled");

            $("#ingressbox").addClass("teal");
            $("#egressbox").addClass("teal");
            $("#maxendpoints").addClass("tealcolor");
            $("#vpnquota").addClass("tealcolor");
            $("#typein").removeAttr("disabled", "disabled");
            $("#typein2").removeAttr("disabled", "disabled");

            document.getElementById('endpoints').value = "";
            document.getElementById('quotasize').value = "";
    ...
    $("#typein").change(function() {
        if ($(this).prop("checked")) {
            //alert("hello")
            $("#typeinb").removeClass("hideme");
            $("#todisable").addClass("disabled");
        } else if ($("#50chk").prop("checked") || $("#100chk").prop("checked") || $("#200chk").prop("checked")) {
            $("#typeinb").addClass("hideme");
            $("#todisable").removeClass("disabled");
        }
    });

    $("#typein2").change(function() {
        if ($(this).prop("checked")) {
            //alert("hello")
            $("#typeinb2").removeClass("hideme");
            $("#todisable2").addClass("disabled");
        } else if ($("#50chk2").prop("checked") || $("#100chk2").prop("checked") || $("#200chk2").prop("checked")) {
            $("#typeinb2").addClass("hideme");
            $("#todisable2").removeClass("disabled");
        }
    });
    ...
    $("#typein3").change(function() {
        if ($(this).prop("checked")) {
            //alert("hello")
            $("#typeinb3").removeClass("hideme");
            $("#todisable3").addClass("disabled");
        } else if ($("#50chk3").prop("checked") || $("#100chk3").prop("checked") || $("#200chk3").prop("checked")) {
            $("#typeinb3").addClass("hideme");
            $("#todisable3").removeClass("disabled");
        }
    });

    $("#typein4").change(function() {
        if ($(this).prop("checked")) {
            //alert("hello")
            $("#typeinb4").removeClass("hideme");
            $("#todisable4").addClass("disabled");
        } else if ($("#50chk4").prop("checked") || $("#100chk4").prop("checked") || $("#200chk4").prop("checked")) {
            $("#typeinb4").addClass("hideme");
            $("#todisable4").removeClass("disabled");
        }
    });
...
$(document).ready(function() {
	...
	$("#getstarted").click(function() {
		...
		$('#menu a[data-tab="second"]').click();
	});
	$("#app2vpn").click(function() {

		$('#menu a[data-tab="third"]').click();
	});
});


function unhide() {
    document.getElementById("typein").style.hideme.display = "block";
}
